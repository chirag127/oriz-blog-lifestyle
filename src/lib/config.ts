...
export const SITE_CONFIG: BlogConfig = {
  title: 'Slow Hours',
  description:
    'Notes on minimalism, daily routines, simple living and keeping focus — a calm lifestyle journal by Chirag Singhal.',
  url: 'https://lifestyle-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-lifestyle') as `${string}/${string}`,
